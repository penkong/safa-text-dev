...
export default {
  ...
  methods: {
    onRemoveSelected() {
      ...
      return this.gridApi.updateRowData({ remove: selectedData });
    },
    updateAndSort() {
...
@import "root/ag-grid-community/src/styles/ag-grid.scss";
@import "root/ag-grid-community/src/styles/ag-theme-balham/sass/ag-theme-balham.scss";
.safa-grid {
  .button-row {
    display: flex;
